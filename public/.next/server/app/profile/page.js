...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4130)), "D:\\next-auth-firebase-main\\app\\profile\\page.jsx"],
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2756)), "D:\\next-auth-firebase-main\\app\\layout.js"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3174))).default(props))],
    apple: [],
    openGraph: [],
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 9815))
...
;// CONCATENATED MODULE: ./app/components/spinner.gif
/* harmony default export */ const spinner = ({"src":"/_next/static/media/spinner.3ed2ce77.gif","height":200,"width":200,"blurWidth":0,"blurHeight":0});
;// CONCATENATED MODULE: ./app/components/Spinner.jsx
...
const page = ()=>{
    const { user } = (0,AuthContext/* UserAuth */._)();
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        className: "p-4",
        children: loading ? /*#__PURE__*/ jsx_runtime_.jsx(components_Spinner, {}) : user ? /*#__PURE__*/ (0,jsx_runtime_.jsxs)("p", {
            children: [
                "Welcome, ",
                user.displayName,
            ...
            children: "You must be logged in to view this page - protected route."
        })
    });
};
/* harmony default export */ const profile_page = (page);
...
var __webpack_exports__ = __webpack_require__.X(0, [381,290,649,919], () => (__webpack_exec__(976)));
